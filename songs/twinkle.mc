...
/* use built-in function to get the first bar in track t3 and assign its value to bar tmp*/
	...
	t3=[-t newb,at(t3,1)];
	track<<sax,1,4,120,0>> t4;
	t4=t3+t3; /* tracks can be concatenated*/
	track<<sax,1,4,120,0>> tall;
tall=t1+t4+t1;
	track<<banjo,1,4,120,0>> tchor;
	...
	tchor2=[-t [-b (~D5;1),(~B4;1),(~C5;1),(~A4;1),(~F4;1),(~G4;1),(~C5;1),(~;1)]];
