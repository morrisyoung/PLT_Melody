...
|Num of int (* Push a literal*)
(*| Cho of int list (* Push a Chord [len; dur; start; p; p; p...]*)
>>>>>>> 3339c100fc6ea29e471b9815509fb8f801b05bbc
...
| Hlt (* Terminate *)
(*******Added by Jingsi**********)
| Nva of (int * int) (*The value of a note*) 
| Bv1 of (bstmt list) (*The value of a bar defined by [note,note,...]*)
| Bv2 of (bstmt * bstmt list) (*The value of a bar defined by [rhythm,(pitch,pitch...)]*)
| Cva of (bstmt list) (*The value of chord [note&note&note]*)
| Tva of (bstmt list) (*The value of a track*)
| Rva of (int list) (*The value of a rhythm*)
| Str of string (*The value of a string*)
(*|Mva*)
| Oat of string * int (*"Object at". The function of at for type bar or track*)
| Tup of string * int (*"toneUp(obj, i)"*)
| Tdn of string * int (*"toneDown(obj, i)"*)
| Len of string (*"length", returns the length of an object*)
(********Added by Jingsi END*********)
type prog = {
